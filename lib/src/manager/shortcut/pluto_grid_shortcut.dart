...
class PlutoGridShortcut {
  ...
  static  Map<ShortcutActivator, PlutoGridShortcutAction> defaultActions(){
    ...
    return
      {
        ...
        LogicalKeySet(isMacos ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control, LogicalKeyboardKey.home):
        const PlutoGridActionMoveCellFocusToEdge(PlutoMoveDirection.up),
        LogicalKeySet(isMacos ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control, LogicalKeyboardKey.end):
        ...
        LogicalKeySet(isMacos ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control, LogicalKeyboardKey.shift,
        ...
        LogicalKeySet(isMacos ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control, LogicalKeyboardKey.keyC):
        const PlutoGridActionCopyValues(),
        // Paste values from clipboard
        LogicalKeySet(isMacos ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control, LogicalKeyboardKey.keyV):
        const PlutoGridActionPasteValues(),
        // Select all cells or rows
        LogicalKeySet(isMacos ? LogicalKeyboardKey.meta : LogicalKeyboardKey.control, LogicalKeyboardKey.keyA):
